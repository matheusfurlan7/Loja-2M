...
begin
  ...
  LCad.Caption := 'Pedido de venda - Histórico por cliente';
  Caption := 'Pedido de venda - Histórico por cliente';
...
begin
  ...
  if (Trim(ECli.Text) = '') then begin
     Beep;
     Application.MessageBox('É preciso informar o cliente!','Aviso',MB_OK+ MB_ICONINFORMATION);
     ECli.SetFocus;
     Exit;
  end;
