...
procedure TFrmRelPadrao.btn_ImprimirClick(Sender: TObject);
begin
   Relatorio.ShowReport;
end;

procedure TFrmRelPadrao.btn_SairClick(Sender: TObject);
begin
   Close;
end;

procedure TFrmRelPadrao.FormShow(Sender: TObject);
