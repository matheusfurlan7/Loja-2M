inherited FrmRelCidade: TFrmRelCidade
  Caption = ''
  ClientHeight = 165
  ClientWidth = 603
  ExplicitWidth = 609
  ...
  inherited Q: TFDQuery
    SQL.Strings = (
      'SELECT CID_PAIS,PAI_NOME, CID_ESTADO,CID_CIDADE FROM CIDADE'
      'INNER JOIN PAIS ON CID_PAIS = PAI_CODIGO')
  end
end
