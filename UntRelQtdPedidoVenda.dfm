inherited FrmRelQtdPedidoVenda: TFrmRelQtdPedidoVenda
  Caption = ''
  ClientHeight = 140
  ClientWidth = 574
  ExplicitWidth = 580
  ...
  inherited PTopo: TPanel
    ...
    inherited LCad: TLabel
      Width = 568
      Height = 30
      Caption = 'Relat'#243'rio - Quantidade de pedido por cliente'
      ExplicitWidth = 461
    end
  end
  ...
  inherited Relatorio: TfrxReport
    ReportOptions.LastChange = 43611.706303807900000000
    Datasets = <
      item
        DataSet = DB
        DataSetName = 'Pedido'
  ...
  object Q: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT COUNT(*) AS QTD, PEV_CLIENTE, PES_RAZAOSOCIAL FROM PEDIDO' +
        'VENDA'
      'INNER JOIN PESSOA ON (PESSOA.PES_CODIGO = PEV_CLIENTE) '
      'GROUP BY PEV_CLIENTE,PES_RAZAOSOCIAL')
    Left = 48
    Top = 60
  end
