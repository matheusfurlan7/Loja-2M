inherited FrmRelPerfil: TFrmRelPerfil
    ...
    inherited Page1: TfrxReportPage
      inherited MasterData1: TfrxMasterData
        ...
        object frxDBDataset1Pes_Situacao: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            '[frxDBDataset1."PER_STATUS"]')
        end
        object frxDBDataset1Pes_Celular: TfrxMemoView
          Left = 576.826771650000000000
          Top = 11.338590000000010000
          Width = 75.590556059999990000
          Height = 18.897650000000000000
          DataField = 'PER_iNCLUSAO'
          DataSet = DBDS
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = 'dd/mm/yyyy'
          DisplayFormat.Kind = fkDateTime
          Memo.UTF8W = (
            '[frxDBDataset1."PER_iNCLUSAO"]')
        end
      end
  ...
  inherited DBDS: TfrxDBDataset
    FieldAliases.Strings = (
      ...
      'PER_iNCLUSAO=PER_iNCLUSAO'
      'PER_DESCRICAO=PER_DESCRICAO')
  end
  inherited Q: TFDQuery
    SQL.Strings = (
      
        'SELECT PER_CODIGO,IIF(PER_STATUS='#39'S'#39','#39'Ativo'#39','#39'Inativo'#39') as PER_S' +
        'TATUS,PER_iNCLUSAO,PER_DESCRICAO FROM PERFIL')
  end
end
