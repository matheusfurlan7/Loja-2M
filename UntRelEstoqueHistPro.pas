...
uses
  ...
  frxExportPDF, Vcl.ComCtrls, Vcl.ToolWin, Vcl.StdCtrls, Vcl.ExtCtrls;

type
  TFrmRelEstoqueHistPro = class(TFrmRelPadrao)
  private
...
var
  FrmRelEstoqueHistPro: TFrmRelEstoqueHistPro;
