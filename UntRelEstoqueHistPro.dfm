inherited FrmRelEstoqueHistPro: TFrmRelEstoqueHistPro
  Caption = ''
  ExplicitWidth = 651
  ExplicitHeight = 338
  PixelsPerInch = 96
  ...
  inherited Relatorio: TfrxReport
    ReportOptions.LastChange = 43608.030453275500000000
    Datasets = <
      item
        DataSet = DBDS
    ...
    inherited Page1: TfrxReportPage
      inherited MasterData1: TfrxMasterData
        ...
        object frxDBDataset1mov_data: TfrxMemoView
        ...
        object frxDBDataset1mov_sequencia: TfrxMemoView
          Left = 102.047310000000000000
          Top = 3.779529999999990000
          Width = 75.590600000000000000
          Height = 18.897650000000000000
          DataField = 'mov_sequencia'
          DataSet = DBDS
          DataSetName = 'frxDBDataset1'
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."mov_sequencia"]')
        end
        object frxDBDataset1mov_saldoAnterior: TfrxMemoView
          Left = 184.440944880000000000
          Top = 3.779529999999990000
          Width = 105.826771650000000000
          Height = 18.897650000000000000
          DataField = 'mov_saldoAnterior'
          DataSet = DBDS
          DataSetName = 'frxDBDataset1'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."mov_saldoAnterior"]')
        end
        object frxDBDataset1mov_tipodemovimento: TfrxMemoView
          ...
          DataSetName = 'frxDBDataset1'
          Memo.UTF8W = (
            '[frxDBDataset1."mov_tipodemovimento"]')
        end
        object frxDBDataset1mov_quantidade: TfrxMemoView
          Left = 403.653543310000000000
        ...
        object frxDBDataset1mov_saldoatual: TfrxMemoView
          Left = 501.921259840000000000
          Top = 3.779530000000000000
          Width = 124.724409450000000000
          Height = 18.897650000000000000
          DataField = 'mov_saldoatual'
          DataSet = DBDS
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2f'
          DisplayFormat.Kind = fkNumeric
  ...
  inherited DBDS: TfrxDBDataset
    FieldAliases.Strings = (
      'mov_data=mov_data'
      'mov_sequencia=mov_sequencia'
      'mov_saldoAnterior=mov_saldoAnterior'
      'mov_tipodemovimento=mov_tipodemovimento'
      'mov_quantidade=mov_quantidade'
      'mov_saldoatual=mov_saldoatual')
  end
  inherited Q: TFDQuery
    Active = True
    SQL.Strings = (
      'select mov_data, mov_sequencia, mov_saldoAnterior,'
      'mov_tipodemovimento,mov_quantidade,mov_saldoatual from movimento')
  end
end
