inherited FrmRelUnidade: TFrmRelUnidade
  Caption = ''
  ClientHeight = 169
  ClientWidth = 500
  ExplicitWidth = 506
  ...
  inherited Relatorio: TfrxReport
    ReportOptions.LastChange = 43607.848400694400000000
    Datasets = <
      item
        DataSet = DBDS
    ...
    inherited Page1: TfrxReportPage
      inherited MasterData1: TfrxMasterData
        ...
        object frxDBDataset1gru_codigo: TfrxMemoView
  ...
  inherited Q: TFDQuery
    SQL.Strings = (
      'select uni_unidade,uni_Descricao from unidade')
  end
end
