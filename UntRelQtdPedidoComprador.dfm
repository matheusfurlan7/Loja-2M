inherited FrmRelQtdPedidoComprador: TFrmRelQtdPedidoComprador
  Caption = ''
  ClientHeight = 136
  ClientWidth = 574
  ExplicitWidth = 580
  ...
  inherited PTopo: TPanel
    ...
    inherited LCad: TLabel
      Width = 568
      Height = 30
      Caption = 'Relat'#243'rio - Quantidade de pedido por fornecedor'
      ExplicitWidth = 505
    end
  end
  ...
  inherited Relatorio: TfrxReport
    ReportOptions.LastChange = 43615.076962534730000000
    Datasets = <
      item
        DataSet = DB
        DataSetName = 'Pedido'
    ...
    inherited Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object PedidoPEC_COMPRADOR: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[Pedido."PEC_FORNECEDOR"]')
        end
        object PedidoPES_RAZAOSOCIAL: TfrxMemoView
      ...
      object Chart1: TfrxChartView
        ...
        SeriesData = <
          item
            ...
            TopN = 0
            XType = xtText
            Source1 = 'Pedido."PES_RAZAOSOCIAL"'
            Source2 = 'Pedido."QTD"'
            XSource = 'Pedido."PES_RAZAOSOCIAL"'
            YSource = 'Pedido."QTD"'
          end>
      end
  ...
  object Q: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT COUNT(*) AS QTD, PEC_FORNECEDOR, PES_RAZAOSOCIAL FROM PED' +
        'IDOCOMPRA '
      'INNER JOIN PESSOA ON (PESSOA.PES_CODIGO = PEC_FORNECEDOR)'
      'GROUP BY PEC_FORNECEDOR,PES_RAZAOSOCIAL')
    Left = 48
    Top = 60
  end
